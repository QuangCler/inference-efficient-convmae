...
class ConvMAE_Ghost_Cls(nn.Module):
    """Ghost ConvMAE classification encoder — mirrors ConvMAE_Baseline_Cls exactly,
    with GhostV2BlockMasked stages 1/2 (called with mask=None at inference)."""

    def __init__(self, num_classes=1000):
        super().__init__()

        mae = convmae_allghost()
...
def convmae_ghost_cls(**kwargs):
    return ConvMAE_Ghost_Cls(**kwargs)
